...
// -----------------------------------------
//
// Source: LocalEcho1.java
// Date  : 26 Oct 2016 10:04:33 ECT
 ...
 * Automatically generated load test program.
 */
public class LocalEcho1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "LocalEcho1ExtParams.dat";            // input file name for very large parameter values
	 ...
	 */
	public LocalEcho1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("LocalEcho1", concurrentUsers);
		...
		performanceData.setInfoText("LocalEcho1");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new LocalEcho1());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				LocalEcho1 simulatedUser = new LocalEcho1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

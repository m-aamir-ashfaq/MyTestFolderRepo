 ...
 */
public class TestWS_MAIN implements WebSocketPluginInterface
{
	private String kkj1Loop = "llloooppp";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@2b881b66"
	 ...
	 *
	 * input parameter #1: (text) kkj1Loop / default value = 'llloooppp' / label "dfischer.proxysniffer.ProxySnifferVar@2b881b66"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				kkj1Loop = (String) parameterValue;
				break;
			default:
				break;
		}
	...
	public WebSocketFrame beforeMessageSent(Object context,WebSocketFrame wsFrame)
	{
		...
		wsFrame.setPayloadString(wsFrame.getPayloadString()+" AmirKhan");
		// ^^^ --- sample code --- ^^^
		return wsFrame;
	}
	 ...
	 *
	 * output parameter #1: (text) kkj1Loop / default value = 'llloooppp' / label "dfischer.proxysniffer.ProxySnifferVar@2b881b66"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			// vvv --- sample code --- vvv
			//
			//TestWS_MAIN plugin = new TestWS_MAIN();

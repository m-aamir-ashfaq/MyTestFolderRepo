...
// -----------------------------------------
//
// Source: testWS_NoPlugin.java
// Date  : 24 Oct 2016 08:52:40 ECT
 ...
 * Automatically generated load test program.
 */
public class testWS_NoPlugin extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testWS_NoPluginExtParams.dat";       // input file name for very large parameter values
	 ...
	 */
	public testWS_NoPlugin(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testWS_NoPlugin", concurrentUsers);
		...
		performanceData.setInfoText("testWS_NoPlugin");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testWS_NoPlugin());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testWS_NoPlugin simulatedUser = new testWS_NoPlugin(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

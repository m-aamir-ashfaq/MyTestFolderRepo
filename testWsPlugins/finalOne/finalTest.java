 ...
 * Automatically generated load test program.
 */
public class finalTest extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "finalTestExtParams.dat";             // input file name for very large parameter values
	 ...
	 */
	public finalTest(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("finalTest", concurrentUsers);
		...
		performanceData.setInfoText("finalTest");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new finalTest());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				finalTest simulatedUser = new finalTest(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

 ...
 * Automatically generated load test program.
 */
public class simple extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "simpleExtParams.dat";                // input file name for very large parameter values
	 ...
	 */
	public simple(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("simple", concurrentUsers);
		...
		performanceData.setInfoText("simple");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new simple());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				simple simulatedUser = new simple(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

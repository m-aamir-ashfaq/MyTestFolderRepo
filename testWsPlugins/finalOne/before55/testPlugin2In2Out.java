 ...
 */
public class testPlugin2In2Out implements WebSocketPluginInterface
{
	private String a = "a";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@5164b7b2"
	private String b = "b";		// input parameter #2 - label "dfischer.proxysniffer.ProxySnifferVar@2b5830dd"
	...
	{
		return "testPlugin2In2Out plug-in";
	}
	 ...
	 *
	 * input parameter #1: (text) a / default value = 'a' / label "dfischer.proxysniffer.ProxySnifferVar@5164b7b2"
	 * input parameter #2: (text) b / default value = 'b' / label "dfischer.proxysniffer.ProxySnifferVar@2b5830dd"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				a = (String) parameterValue;
				break;
			case 1:
				b = (String) parameterValue;
				break;
			default:
				break;
		}
	...
	public void execute(Object context)
	{
		...
		//  int addOffsetMillis = 3000; // this message will be sent '3' second after the web socket connection is established.
		...
		// ------------------------
		//  int position = 3; //suppose we want to add delay to the existing delay before 3rd frame.
	 ...
	 *
	 * output parameter #1: (text) a / default value = 'a' / label "dfischer.proxysniffer.ProxySnifferVar@5164b7b2"
	 * output parameter #2: (text) b / default value = 'b' / label "dfischer.proxysniffer.ProxySnifferVar@2b5830dd"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			// vvv --- sample code --- vvv
			//
			//testPlugin2In2Out plugin = new testPlugin2In2Out();

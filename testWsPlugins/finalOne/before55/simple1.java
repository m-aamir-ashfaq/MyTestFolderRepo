 ...
 * Automatically generated load test program.
 */
public class simple1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "simple1ExtParams.dat";               // input file name for very large parameter values
	...
	private static Object wsplugin01 = null;                      // plug-in #1: "testNnStatic" - definition from web admin var handler: construction scope = global
	private static String wsplugin01testNnStatic = null;          // internal - not used in this load test program, but used by the GUI - reflective information
	 ...
	 */
	public simple1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [1] <- WEB ADMIN Index 61 ---
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: qjUYhg5JoqklWe89Vh0XIQ==\r\n" + 
		...
		webSocketData = getWebSocketData_1479282989070();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("simple1", concurrentUsers);
		...
		performanceData.setInfoText("simple1");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new simple1());
		
		try
		{
			// define object for web socket plug-in #1 and call web socket plug-in constructor
			Class wspluginClass0 = getPluginClassLoader().getPluginClass("testNnStatic");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				simple1 simulatedUser = new simple1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1479282989070()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1479282989189L);
		webSocketData.setConnectionStopMillis(1479283045505L);
		...
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1479282992142L,1479282992143L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1479282995535L,1479282995536L , "UTF-8" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1479283007514L,1479283007516L , "UTF-8" , payLoad_4 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1479283043673L,1479283043674L , "UTF-8" , payLoad_6 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1479283045387L,1479283045388L , "UTF-8" , payLoad_8 ));

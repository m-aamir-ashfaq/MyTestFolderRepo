 ...
 */
public class DemoPlugin implements WebSocketPluginInterface
{
	private String newVar = "";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@f5fc68a"
	 ...
	 *
	 * input parameter #1: (text) newVar / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@f5fc68a"
	 *
	 ...
	 *
	 * output parameter #1: (text) newVar / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@f5fc68a"
	 *

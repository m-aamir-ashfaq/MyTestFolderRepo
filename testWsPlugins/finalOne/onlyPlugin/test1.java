...
public class test1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [1] <- WEB ADMIN Index 63 ---
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: kR2Nibao6aYBlAaJy2/Btg==\r\n" + 
		...
		webSocketData = getWebSocketData_1480580838259();
		...
		{
			// extract var 'Rock'
			Rock = Lib.extractTextToken( testURL.getWebSocketContext().getWebSocketRecordedData().getWebSocketFramesWithoutPingPong().get(1).getPayloadString(), 1, "< >'=&\"");		// recorded value = Rock
			log("<<< Rock = " + Rock);
		}
	...
	public WebSocketData getWebSocketData_1480580838259()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1480580838365L);
		webSocketData.setConnectionStopMillis(1480580853459L);
		String payLoad_0 = "Rock it with HTML5 WebSocket 1";
		String payLoad_2 = "Rock it with HTML5 WebSocket 2";
		String payLoad_4 = "";

		// search and replace frame payload "HTML5" with variable 'Rock' on all occurrences of frame no 2
		payLoad_2 = Lib.replaceTextPattern(payLoad_2, "HTML5", Rock, 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1480580844009L,1480580844009L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1480580850429L,1480580850429L , "UTF-8" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1480580853354L,1480580853354L , "UTF-8" , payLoad_4 ));

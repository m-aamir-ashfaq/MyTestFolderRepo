 ...
 * Automatically generated load test program.
 */
public class testWS1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testWS1ExtParams.dat";               // input file name for very large parameter values
	 ...
	 */
	public testWS1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		((GenericPluginInterface) wsplugin01).setInputParameter(1, kkj1Loop);			// set plug-in input parameter
		...
		kkj1Loop = (String) ((GenericPluginInterface) wsplugin01).getOutputParameter(1);		// get web socket plug-in output parameter
		log("<<< kkj1Loop = " + kkj1Loop);
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testWS1", concurrentUsers);
		...
		performanceData.setInfoText("testWS1");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testWS1());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testWS1 simulatedUser = new testWS1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

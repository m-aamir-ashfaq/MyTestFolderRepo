...
// -----------------------------------------
//
// Source: LocalEcho.java
// Date  : 24 Oct 2016 10:14:02 ECT
 ...
 * Automatically generated load test program.
 */
public class LocalEcho extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "LocalEchoExtParams.dat";             // input file name for very large parameter values
	 ...
	 */
	public LocalEcho(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("LocalEcho", concurrentUsers);
		...
		performanceData.setInfoText("LocalEcho");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new LocalEcho());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				LocalEcho simulatedUser = new LocalEcho(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

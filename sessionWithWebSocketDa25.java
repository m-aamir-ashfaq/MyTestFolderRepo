...
// -----------------------------------------
//
// Source: sessionWithWebSocketDa25.java
// Date  : 29 Jun 2016 13:02:41 ECT
 ...
 * Automatically generated load test program.
 */
public class sessionWithWebSocketDa25 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "sessionWithWebSocketDa25ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public sessionWithWebSocketDa25()
	{
		super();
	}
	 ...
	 */
	public sessionWithWebSocketDa25(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// search and replace frame payload "HTML5" with variable 'testAssign' on all occurrences of frame no -1
		payLoad_-1 = Lib.replaceTextPattern(payLoad_-1, "HTML5", testAssign, 0)
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("sessionWithWebSocketDa25", concurrentUsers);
		...
		performanceData.setInfoText("sessionWithWebSocketDa25");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				sessionWithWebSocketDa25 simulatedUser = new sessionWithWebSocketDa25(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

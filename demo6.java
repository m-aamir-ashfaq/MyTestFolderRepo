...
public class demo6 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	public static WebSocketData getWebSocketData_1470686470486()
	{
		...
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686471848L,1470686471849L , payLoad_0 , "Rock it with HTML5 WebSocket" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686471955L,1470686471956L , payLoad_1 , "Rock it with HTML5 WebSocket" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686473195L,1470686473196L , payLoad_2 , "Rock it with HTML5 WebSocket" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686473298L,1470686473300L , payLoad_3 , "Rock it with HTML5 WebSocket" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686484051L,1470686484052L , payLoad_4 , "bye...thats all" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686484155L,1470686484157L , payLoad_5 , "bye...thats all" , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1470686485183L,1470686485184L , payLoad_6 , " " , "" ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 8 , 1470686485288L,1470686485289L , payLoad_7 , " " , "" ));

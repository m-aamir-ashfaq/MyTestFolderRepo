...
// -----------------------------------------
//
// Source: SvtPlay_PlayEpisode_v3.java
// Date  : 25 Nov 2016 11:38:44 ECT
 ...
 * Automatically generated load test program.
 */
public class SvtPlay_PlayEpisode_v3 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "SvtPlay_PlayEpisode_v3ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public SvtPlay_PlayEpisode_v3(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("SvtPlay_PlayEpisode_v3", concurrentUsers);
		...
		performanceData.setInfoText("SvtPlay_PlayEpisode_v3");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new SvtPlay_PlayEpisode_v3());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				SvtPlay_PlayEpisode_v3 simulatedUser = new SvtPlay_PlayEpisode_v3(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

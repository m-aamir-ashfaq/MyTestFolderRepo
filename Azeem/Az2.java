...
public class Az2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JSON", null, 8327, 5);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		requestContent0019 = Lib.replaceTextPattern(requestContent0019, "paistanLAHORE", user_pass, 0);		// search and replace content fragment "paistanLAHORE" with variable 'user_pass' on all occurrences
		requestContent0019 = Lib.replaceTextPattern(requestContent0019, "Khan", user_lastName, 0);		// search and replace content fragment "Khan" with variable 'user_lastName' on all occurrences
		requestContent0019 = Lib.replaceTextPattern(requestContent0019, "amir1106@gmail.com", user_email, 0);		// search and replace content fragment "amir1106@gmail.com" with variable 'user_email' on all occurrences
		requestContent0019 = Lib.replaceTextPattern(requestContent0019, "Amir", user_fName, 0);		// search and replace content fragment "Amir" with variable 'user_fName' on all occurrences
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		requestContent0021 = Lib.replaceTextPattern(requestContent0021, "paistanLAHORE", user_pass, 0);		// search and replace content fragment "paistanLAHORE" with variable 'user_pass' on all occurrences
		requestContent0021 = Lib.replaceTextPattern(requestContent0021, "amir1106@gmail.com", user_email, 0);		// search and replace content fragment "amir1106@gmail.com" with variable 'user_email' on all occurrences

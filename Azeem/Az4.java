 ...
 * Automatically generated load test program.
 */
public class Az4 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "Az4ExtParams.dat";                   // input file name for very large parameter values
	 ...
	 */
	public Az4(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("Az4", concurrentUsers);
		...
		performanceData.setInfoText("Az4");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new Az4());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				Az4 simulatedUser = new Az4(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

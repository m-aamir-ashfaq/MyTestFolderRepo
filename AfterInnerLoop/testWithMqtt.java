 ...
 */
public class testWithMqtt implements WebSocketPluginInterface
{
	private String clientID = "";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@29d3bfb8"
	 ...
	 *
	 * input parameter #1: (text) clientID / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@29d3bfb8"
	 *
	...
	public void execute(Object context)
	{
		...
		//  int index  = 1; // index of a frame, before which the delay will be added.
		//  webSocketContext.addWebSocketDelay(delay, index);
		//  ____________________________________________________________________________________________________________)
	...
	public static void main(String[] args)
	{
		try
		{
			// vvv --- sample code --- vvv
			//
			//testWithMqtt plugin = new testWithMqtt();

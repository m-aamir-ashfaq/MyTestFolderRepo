...
// -----------------------------------------
//
// Source: testAll_1_2.java
// Date  : 27 Jan 2017 11:10:35 ECT
 ...
 * Automatically generated load test program.
 */
public class testAll_1_2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testAll_1_2ExtParams.dat";           // input file name for very large parameter values
	 ...
	 */
	public testAll_1_2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// execute inline script "generate clientId before hiveMQTT"
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testAll_1_2", concurrentUsers);
		...
		performanceData.setInfoText("testAll_1_2");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testAll_1_2());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testAll_1_2 simulatedUser = new testAll_1_2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	// source code of inline script "generate clientId before hiveMQTT"
	...
	/**
	* Execute the inline script "generate clientId before hiveMQTT"
	* 
	...
	*/
	...
	{
		LoadtestInlineScriptContext inlineScriptContext = new LoadtestInlineScriptContext("generate clientId before hiveMQTT", ProxySnifferVarSourceInlineScript.EXEC_SCOPE_URL_END, "", this, LoadtestInlineScriptContext.RESULT_TYPE_SET_OUTPUT_VARS, 15, threadNumber, threadLoopCounter, socketPool, cookieHandler, testURL, threadStep);

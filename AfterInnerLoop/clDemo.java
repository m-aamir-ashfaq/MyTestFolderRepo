 ...
 * Automatically generated load test program.
 */
public class clDemo extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "clDemoExtParams.dat";                // input file name for very large parameter values
	 ...
	 */
	public clDemo(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("clDemo", concurrentUsers);
		...
		performanceData.setInfoText("clDemo");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new clDemo());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				clDemo simulatedUser = new clDemo(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

 ...
 * Automatically generated load test program.
 */
public class clDemo3 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "clDemo3ExtParams.dat";               // input file name for very large parameter values
	 ...
	 */
	public clDemo3(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("clDemo3", concurrentUsers);
		...
		performanceData.setInfoText("clDemo3");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new clDemo3());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				clDemo3 simulatedUser = new clDemo3(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

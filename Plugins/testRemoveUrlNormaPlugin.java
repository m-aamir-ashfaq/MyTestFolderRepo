...
// -----------------------------------------
//
// Source: testRemoveUrlNormaPlugin.java
// Date  : 09 Nov 2016 10:14:15 ECT
 ...
 * Automatically generated load test program.
 */
public class testRemoveUrlNormaPlugin extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testRemoveUrlNormaPluginExtParams.dat";// input file name for very large parameter values
	...
	private static Object plugin0001 = null;                      // plug-in #1: "pluginWithNoVariable" - definition from web admin var handler: construction scope = global
	private static String plugin0001pluginWithNoVariable = null;  // internal - not used in this load test program, but used by the GUI - reflective information

	/**
	 * constructor: called from load test plug-ins (scope = global).
	 */
	public testRemoveUrlNormaPlugin()
	{
		super();
	}
	 ...
	 */
	public testRemoveUrlNormaPlugin(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		log(">>> execute plug-in #1: pluginWithNoVariable");
		synchronized (plugin0001)
		{
			((GenericPluginInterface) plugin0001).execute(urlPluginBeforeCallContext0001);			// execute plug-in
		...
		// --- HTTP REQUEST: Test [2] <- WEB ADMIN Index 93 ---
		String requestProt0002 = "https";
		String requestHost0002 = "ie12.zopim.com";
		int    requestPort0002 = 443;
		String requestFile0002 = "/s/W/ws/U0WSVa6qA-51E9a3/c/1477493762192";
		...
		String requestHost0003 = "echo.websocket.org";
		...
		// --- HTTP REQUEST: Test [4] <- WEB ADMIN Index 135 ---
		String requestProt0004 = "https";
		String requestHost0004 = "ie12.zopim.com";
		int    requestPort0004 = 443;
		String requestFile0004 = "/s/W/ws/6kJKYbEhDKWOIGe9/c/1477493792600";
		...
		String requestHost0005 = "echo.websocket.org";
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testRemoveUrlNormaPlugin", concurrentUsers);
		...
		performanceData.setInfoText("testRemoveUrlNormaPlugin");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testRemoveUrlNormaPlugin());
		// initialize all global constructed plug-ins
		try
		{
			// define object for plug-in #1 and call plug-in constructor
			Class pluginClass0 = getPluginClassLoader().getPluginClass("pluginWithNoVariable");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testRemoveUrlNormaPlugin simulatedUser = new testRemoveUrlNormaPlugin(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

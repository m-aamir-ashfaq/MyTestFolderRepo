...
// -----------------------------------------
//
// Source: LOADtestmissingAssignUrl.java
// Date  : 06 Apr 2016 13:17:41 ECT
 ...
 * Automatically generated load test program.
 */
public class LOADtestmissingAssignUrl extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "LOADtestmissingAssignUrlExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public LOADtestmissingAssignUrl()
	{
		super();
	}
	 ...
	 */
	public LOADtestmissingAssignUrl(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	private boolean execute(int totalLoopCounter) throws Exception
	{
		...
		log();
		log();
		log("# Page #1: Choose quality");
		log("# -----------------------");
		threadStep = setPageBreak(performanceData, threadStep, "Page #1: Choose quality", 3000, 35, -1);		// hint: param #4 is the user's think time in milliseconds, param #5 is randomness of the user's think time in percent (+/- 0..100%), param #6 is the maximum acceptable response time in milliseconds (-1 = not configured)
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "tv4play3-vh.akamaihd.net";
		int    requestPort0001 = 80;
		String requestFile0001 = "/i/mp4root/2010-05-26/pid2697563_1017580_,T3MP43,T3MP48,T3MP415,_.mp4.csmil/index_2_av.m3u8";
		System.out.println("amir>>" + quality);
		requestFile0001 = Lib.replaceTextPattern(requestFile0001, "/i/mp4root/2010-05-26/pid2697563_1017580_,T3MP43,T3MP48,T3MP415,_.mp4.csmil/index_2_av.m3u8", quality, 0);		// search and replace request file fragment "/i/mp4root/2010-05-26/pid2697563_1017580_,T3MP43,T3MP48,T3MP415,_.mp4.csmil/index_2_av.m3u8" with variable 'quality' on all occurrences
		...
		// content test algorithm: check size +/- 5%, defined content size = 20755
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/VND.APPLE.MPEGURL", null, 20755, 5);		// Test [1] <- Index 1
		if (!urlCallPassed)
		{
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("LOADtestmissingAssignUrl", concurrentUsers);
		...
		performanceData.setInfoText("LOADtestmissingAssignUrl");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				LOADtestmissingAssignUrl simulatedUser = new LOADtestmissingAssignUrl(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

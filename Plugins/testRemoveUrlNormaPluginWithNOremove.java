...
// -----------------------------------------
//
// Source: testRemoveUrlNormaPluginWithNOremove.java
// Date  : 09 Nov 2016 10:16:47 ECT
 ...
 * Automatically generated load test program.
 */
public class testRemoveUrlNormaPluginWithNOremove extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testRemoveUrlNormaPluginWithNOremoveExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public testRemoveUrlNormaPluginWithNOremove()
	{
		super();
	}
	 ...
	 */
	public testRemoveUrlNormaPluginWithNOremove(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [1] <- WEB ADMIN Index 92 ---
		String requestProt0001 = "https";
		String requestHost0001 = "ie12.zopim.com";
		int    requestPort0001 = 443;
		String requestFile0001 = "/s/W/ws/U0WSVa6qA-51E9a3/c/1477493762192";
		...
		// --- HTTP REQUEST: Test [3] <- WEB ADMIN Index 134 ---
		String requestProt0003 = "https";
		String requestHost0003 = "ie12.zopim.com";
		int    requestPort0003 = 443;
		String requestFile0003 = "/s/W/ws/6kJKYbEhDKWOIGe9/c/1477493792600";
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testRemoveUrlNormaPluginWithNOremove", concurrentUsers);
		...
		final int MAX_THREAD_STEPS = 5;  // number of URL requests in execute() - modify this value if you add or delete some requests
		...
		performanceData.setInfoText("testRemoveUrlNormaPluginWithNOremove");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testRemoveUrlNormaPluginWithNOremove());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testRemoveUrlNormaPluginWithNOremove simulatedUser = new testRemoveUrlNormaPluginWithNOremove(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

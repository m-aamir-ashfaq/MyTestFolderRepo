 ...
 */
public class bbc implements LoadtestPluginInterface
{
	private String input1 = "";		// input parameter #1 - label "b"
	private String input2 = "";		// input parameter #2 - label "bb"
	
	private String output1 = "";		// output parameter #1 - label "bbb"
	 ...
	 *
	 * input parameter #1: (String) input1 / default value = '' / label "b"
	 * input parameter #2: (String) input2 / default value = '' / label "bb"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				input1 = (String) parameterValue;
				break;
			case 1:
				input2 = (String) parameterValue;
				break;
			default:
				break;
		}
	 ...
	 *
	 * output parameter #1: (String) output1 / default value = '' / label "bbb"
	 *

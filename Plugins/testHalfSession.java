...
// -----------------------------------------
//
// Source: testHalfSession.java
// Date  : 21 Apr 2016 13:43:20 ECT
 ...
 * Automatically generated load test program.
 */
public class testHalfSession extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testHalfSessionExtParams.dat";       // input file name for very large parameter values
	 ...
	 */
	public testHalfSession(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testHalfSession", concurrentUsers);
		...
		final int MAX_THREAD_STEPS = 35;  // number of URL requests in execute() - modify this value if you add or delete some requests
		...
		performanceData.setInfoText("testHalfSession");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testHalfSession simulatedUser = new testHalfSession(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

...
// -----------------------------------------
//
// Source: INLINE_SCRIPT_02.java
// Date  : 22 Jan 2016 13:46:15 ECT
 ...
 * Automatically generated load test program.
 */
public class INLINE_SCRIPT_02 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "INLINE_SCRIPT_02ExtParams.dat";      // input file name for very large parameter values
	 ...
	 */
	public INLINE_SCRIPT_02(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("INLINE_SCRIPT_02", concurrentUsers);
		...
		performanceData.setInfoText("INLINE_SCRIPT_02");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				INLINE_SCRIPT_02 simulatedUser = new INLINE_SCRIPT_02(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

...
public class test1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static String tempVar = "tempVar";                                   // var declaration from web admin var handler: scope = global
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "broker.mqttdashboard.com";
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: r2VcM96v4Jy6PgZUY2rIFA==\r\n" + 
		...
		webSocketData = getWebSocketData_1481789010846();
		...
		String requestHost0002 = "aus5.mozilla.org";
		int    requestPort0002 = 443;
		String requestFile0002 = "/update/6/Firefox/50.0.2/20161129173726/Darwin_x86_64-gcc3-u-i386-x86_64/en-GB/release/Darwin%2016.1.0/NA/default/default/update.xml";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/XML", null, 42, 5);		// Test [2] <- Index 2
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println("global var <<< tempVar = " + tempVar);
			System.out.println();
		}
	...
	public WebSocketData getWebSocketData_1481789010846()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1481789010889L);
		webSocketData.setConnectionStopMillis(1481789030616L);
		String payLoad_0 = "{\"DUP\":false,\"QoS\":0,\"last_will_Flag\":1,\"last_will_message\":\"(_++)*(&^%$#@NM<BVCXZ!@#|})\",\"type\":\"CONNECT\",\"last_will_QoS\":0,\"protocol_version\":3,\"user_name\":\"userAmir\",\"userNameFlag\":1,\"user_password\":\"passIfra\",\"retain\":false,\"keep_alive\":60,\"client_id\":\"clientId-yf66aq7n2w\",\"last_will_topic\":\"LW_TOPIC\",\"clean_session\":true,\"protocol_name\":\"MQIsdp\",\"passwordFlag\":1}";
		String payLoad_2 = "{\"subscribe_topics\":[{\"subscribe_topic\":\"testtopic/topicAmir\",\"subscribe_QoS\":2}],\"DUP\":false,\"QoS\":1,\"messageID\":256,\"retain\":false,\"type\":\"SUBSCRIBE\"}";
		String payLoad_5 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"PUBREC\"}";
		String payLoad_7 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"PUBCOMP\"}";
		String payLoad_8 = "{\"DUP\":false,\"QoS\":2,\"messageID\":256,\"contents\":\"lets see now...no retail\",\"publish_topic\":\"\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_10 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"PUBREL\"}";
		String payLoad_12 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"PUBREC\"}";
		String payLoad_15 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"PUBCOMP\"}";
		String payLoad_16 = "{\"DUP\":false,\"QoS\":1,\"messageID\":256,\"retain\":false,\"type\":\"UNSUBSCRIBE\",\"unsubscribe_topic\":[\"testtopic/topicAmir\"]}";
		String payLoad_18 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"DISCONNECT\"}";
		String payLoad_19 = "";


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789010931L,1481789010936L , payLoad_0, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789014070L,1481789014072L , payLoad_2, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789014115L,1481789014116L , payLoad_5, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789014159L,1481789014160L , payLoad_7, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789017886L,1481789017887L , payLoad_8, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789017925L,1481789017926L , payLoad_10, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789017931L,1481789017932L , payLoad_12, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789018001L,1481789018002L , payLoad_15, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789025889L,1481789025892L , payLoad_16, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1481789030398L,1481789030400L , payLoad_18, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1481789030400L,1481789030402L , payLoad_19, 1 ));

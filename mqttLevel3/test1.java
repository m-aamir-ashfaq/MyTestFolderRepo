...
public class test1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static String kkj = "";                                              // var declaration from web admin var handler: scope = global
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: pdU2UU9TKFM3UAGYMgPAeg==\r\n" + 
		...
		webSocketData = getWebSocketData_1482142858663();
	...
	public WebSocketData getWebSocketData_1482142858663()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1482142858698L);
		webSocketData.setConnectionStopMillis(1482142888629L);
		String payLoad_0 = "{\"DUP\":false,\"QoS\":0,\"last_will_Flag\":1,\"last_will_message\":\"lwmmmm\",\"type\":\"CONNECT\",\"last_will_QoS\":0,\"protocol_version\":3,\"user_name\":\"uuuu\",\"userNameFlag\":1,\"user_password\":\"pppp\",\"retain\":false,\"keep_alive\":60,\"client_id\":\"clientId-8REUkAs4eQ\",\"last_will_topic\":\"lwtttt\",\"clean_session\":true,\"protocol_name\":\"MQIsdp\",\"passwordFlag\":1}";
		...
		String payLoad_4 = "{\"DUP\":false,\"QoS\":0,\"contents\":\"m &#167;1\",\"publish_topic\":\"testtopic/topicAmir\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_6 = "{\"DUP\":false,\"QoS\":1,\"messageID\":1,\"retain\":false,\"type\":\"UNSUBSCRIBE\",\"unsubscribe_topic\":[\"testtopic/topicAmir\"]}";
		String payLoad_8 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"DISCONNECT\"}";
		String payLoad_9 = "";

		// replace field  "client_id" with variable 'kkj'  of frame no 0
		payLoad_0 = Lib.replaceJsonField(payLoad_0, "client_id", kkj);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1482142858701L,1482142858702L , payLoad_0, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1482142869894L,1482142869897L , payLoad_2, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1482142879158L,1482142879159L , payLoad_4, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1482142886321L,1482142886323L , payLoad_6, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1482142888599L,1482142888600L , payLoad_8, 1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1482142888600L,1482142888602L , payLoad_9, 1 ));

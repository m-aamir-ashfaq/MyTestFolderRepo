...
// -----------------------------------------
//
// Source: test1Var.java
// Date  : 03 Jan 2017 08:36:36 ECT
 ...
 * Automatically generated load test program.
 */
public class test1Var extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "test1VarExtParams.dat";              // input file name for very large parameter values
	...
	private static String kkj = "89986";                                         // var declaration from web admin var handler: scope = global
	 ...
	 */
	public test1Var(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("test1Var", concurrentUsers);
		...
		performanceData.setInfoText("test1Var");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new test1Var());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				test1Var simulatedUser = new test1Var(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1482241076725()
	{
		...
		// search and replace field "client_id" with variable 'kkj' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceJsonFieldPattern(payLoad_0, "client_id", "YVoM3", kkj, 0);

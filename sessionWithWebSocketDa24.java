...
// -----------------------------------------
//
// Source: sessionWithWebSocketDa24.java
// Date  : 28 Jun 2016 12:16:20 ECT
 ...
 * Automatically generated load test program.
 */
public class sessionWithWebSocketDa24 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "sessionWithWebSocketDa24ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public sessionWithWebSocketDa24()
	{
		super();
	}
	 ...
	 */
	public sessionWithWebSocketDa24(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		{
			// extract var 'ss'
			ss = Lib.extractTextToken(testURL.getHeaderField("123123123112312312311231231231123123123112312312311231231231123123123112312312311231231231123123123112312312311231231medium126"), 1, "< >'=&\"1");		// recorded value = 23
			log("<<< ss = " + ss);
		}
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("sessionWithWebSocketDa24", concurrentUsers);
		...
		performanceData.setInfoText("sessionWithWebSocketDa24");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				sessionWithWebSocketDa24 simulatedUser = new sessionWithWebSocketDa24(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

...
// -----------------------------------------
//
// Source: seeEncoding.java
// Date  : 05 Dec 2016 09:26:10 ECT
 ...
 * Automatically generated load test program.
 */
public class seeEncoding extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "seeEncodingExtParams.dat";           // input file name for very large parameter values
	 ...
	 */
	public seeEncoding(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHeader0002 = "GET " + requestFile0002 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: 7UQXdyHA6gxrzhjWpJDjHg==\r\n" + 
		...
		webSocketData = getWebSocketData_1480926303665();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("seeEncoding", concurrentUsers);
		...
		performanceData.setInfoText("seeEncoding");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new seeEncoding());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				seeEncoding simulatedUser = new seeEncoding(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1480926303665()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1480926303693L);
		webSocketData.setConnectionStopMillis(1480926333305L);
		String payLoad_0 = "\u0010!\u0000\u0006MQIsdp\u0003\u0002\u0000<\u0000\u0013clientId-AFrZ8znyqa";
		...
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926303695L,1480926303696L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309032L,1480926309033L , "ISO-8859-1" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309102L,1480926309103L , "UTF-8" , payLoad_13 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309105L,1480926309106L , "UTF-8" , payLoad_14 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309110L,1480926309112L , "UTF-8" , payLoad_15 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309198L,1480926309199L , "UTF-8" , payLoad_17 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309228L,1480926309230L , "UTF-8" , payLoad_20 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309236L,1480926309238L , "UTF-8" , payLoad_21 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926309330L,1480926309333L , "UTF-8" , payLoad_23 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480926333273L,1480926333274L , "ISO-8859-1" , payLoad_24 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1480926333274L,1480926333275L , "UTF-8" , payLoad_25 ));

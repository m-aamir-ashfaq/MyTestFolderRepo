...
// -----------------------------------------
//
// Source: demo8_DE4.java
// Date  : 11 Aug 2016 12:59:30 ECT
 ...
 * Automatically generated load test program.
 */
public class demo8_DE4 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "demo8_DE4ExtParams.dat";             // input file name for very large parameter values
	 ...
	 */
	public demo8_DE4(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("demo8_DE4", concurrentUsers);
		...
		performanceData.setInfoText("demo8_DE4");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				demo8_DE4 simulatedUser = new demo8_DE4(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

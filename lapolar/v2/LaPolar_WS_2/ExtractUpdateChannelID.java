 ...
 */
public class ExtractUpdateChannelID implements WebSocketPluginInterface
{
	private String newChannel = "";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@29c61b21"
...
boolean extracted = false;
	...
	{
		return "ExtractUpdateChannelID plug-in";
	}
	 ...
	 *
	 * input parameter #1: (text) newChannel / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@29c61b21"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				newChannel = (String) parameterValue;
				break;
			default:
				break;
		}
		...
		public WebSocketFrame beforeMessageSent(Object context,WebSocketFrame wsFrame)
		{
			...
			if(extracted)
			{
				// 			String originalPayload = wsFrame.getPayloadString();
				// 			originalPayload.
				// 			newChannel

				// wsFrame.setPayloadString()
			}
	...
	public void afterMessageReceived(Object context,WebSocketFrame wsFrame)
	{
		...
		if(!extracted)
		{
			if(input.contains("\"topic\":\"updateChannel\"") &&  input.contains("results"))
        	{
	 ...
	 *
	 * output parameter #1: (text) newChannel / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@29c61b21"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			// vvv --- sample code --- vvv
			//
			//ExtractUpdateChannelID plugin = new ExtractUpdateChannelID();

 ...
 */
public class forCallI implements WebSocketPluginInterface
{
	private String valueFromP1 = "";		// input parameter #1 - label "dfischer.proxysniffer.ProxySnifferVar@4f3a2bf2"
	 ...
	 *
	 * input parameter #1: (text) valueFromP1 / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@4f3a2bf2"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				valueFromP1 = (String) parameterValue;
				break;
			default:
				break;
		}
	 ...
	 *
	 * output parameter #1: (text) valueFromP1 / default value = '' / label "dfischer.proxysniffer.ProxySnifferVar@4f3a2bf2"
	 *

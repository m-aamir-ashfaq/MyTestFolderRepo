 ...
 * Automatically generated load test program.
 */
public class demo6 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "demo6ExtParams.dat";                 // input file name for very large parameter values
	 ...
	 */
	public demo6(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [1] <- WEB ADMIN Index 83 ---
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: k21yPzrMWRy3vtE0BvxxKw==\r\n" + 
		...
		webSocketData = getWebSocketData_1470686470486();
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {101}, null, null, "kkj","1");		// Test [1] <- Index 1
		if (!urlCallPassed)
		{
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("demo6", concurrentUsers);
		...
		performanceData.setInfoText("demo6");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				demo6 simulatedUser = new demo6(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public static WebSocketData getWebSocketData_1470686470486()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1470686470590L);
		webSocketData.setConnectionStopMillis(1470686485289L);
		...
		String payLoad_3 = "Rock it with HTML5 WebSocket";
		String payLoad_4 = "bye...thats all";
		String payLoad_5 = "bye...thats all";
		String payLoad_6 = "";
		String payLoad_7 = "";

		// search and replace frame payload "WebSocket" with variable 'kkj' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceTextPattern(payLoad_0, "WebSocket", kkj, 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686471848L,1470686471849L , payLoad_0 , Rock it with HTML5 WebSocket , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686471955L,1470686471956L , payLoad_1 , Rock it with HTML5 WebSocket , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686473195L,1470686473196L , payLoad_2 , Rock it with HTML5 WebSocket , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686473298L,1470686473300L , payLoad_3 , Rock it with HTML5 WebSocket , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470686484051L,1470686484052L , payLoad_4 , bye...thats all , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470686484155L,1470686484157L , payLoad_5 , bye...thats all , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1470686485183L,1470686485184L , payLoad_6 ,  , null));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 8 , 1470686485288L,1470686485289L , payLoad_7 ,  , null));

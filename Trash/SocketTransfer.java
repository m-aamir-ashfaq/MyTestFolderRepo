...
// -----------------------------------------
//
// Source: SocketTransfer.java
// Date  : 29 May 2017 10:59:02 ECT
 ...
 * Automatically generated load test program.
 */
public class SocketTransfer extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "SocketTransferExtParams.dat";        // input file name for very large parameter values
	...
	private static String someVar = "SomeValue";                                 // var declaration from web admin var handler: scope = global
	...
	private static Object wsplugin01 = null;                      // plug-in #1: "sree" - definition from web admin var handler: construction scope = global
	private static String wsplugin01sree = null;                  // internal - not used in this load test program, but used by the GUI - reflective information
	 ...
	 */
	public SocketTransfer(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "de18.zopim.com";
		int    requestPort0001 = 443;
		String requestFile0001 = "/s/W/ws/awkmGcFdkxxGh+GG/c/1496047105016";
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: F69srVqHxNXZ2bnqvE5CUQ==\r\n" + 
		...
		webSocketData = getWebSocketData_1496047105200();
		...
		String requestHost0003 = "www.websocket.org";
		int    requestPort0003 = 443;
		String requestFile0003 = "/css/bootstrap.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 122542
		// content test algorithm: check size +/- 5%, defined content size = 122542
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 122542, 5);		// Test [3] <- Index 3
		if (!urlCallPassed)
		{
		...
		String requestHost0004 = "fonts.googleapis.com";
		int    requestPort0004 = 443;
		String requestFile0004 = "/css" +
				"?family=Open+Sans:100,200,300,400,400italic,500,600,700,700,800,900italic" +
				"&subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese";
		...
		// content test algorithm: check size +/- 5%, defined content size = 1143
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 1143, 5);		// Test [4] <- Index 4
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0005 = "fonts.googleapis.com";
		int    requestPort0005 = 443;
		String requestFile0005 = "/css" +
				"?family=ABeeZee:100,200,300,400,400italic,500,600,700,700,800,900italic" +
				"&subset=latin,greek-ext,cyrillic,latin-ext,greek,cyrillic-ext,vietnamese";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 301
		// content test algorithm: check size +/- 5%, defined content size = 301
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 301, 5);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0006 = "maxcdn.bootstrapcdn.com";
		int    requestPort0006 = 443;
		String requestFile0006 = "/font-awesome/4.4.0/css/font-awesome.min.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 6695
		// content test algorithm: check size +/- 5%, defined content size = 6695
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 6695, 5);		// Test [6] <- Index 6
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestFile0007 = "/css/prettify.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 1255
		// content test algorithm: check size +/- 5%, defined content size = 1255
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 1255, 5);		// Test [7] <- Index 7
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestFile0008 = "/css/style.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 53235
		// content test algorithm: check size +/- 5%, defined content size = 53235
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 53235, 5);		// Test [8] <- Index 8
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestFile0009 = "/css/skins/orange.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 1228
		// content test algorithm: check size +/- 5%, defined content size = 1228
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 1228, 5);		// Test [9] <- Index 9
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0010 = "www.websocket.org";
		int    requestPort0010 = 443;
		String requestFile0010 = "/css/animate.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 86478
		// content test algorithm: check size +/- 5%, defined content size = 86478
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 86478, 5);		// Test [10] <- Index 10
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0011 = "www.websocket.org";
		int    requestPort0011 = 443;
		String requestFile0011 = "/css/shortcodes.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 27122
		// content test algorithm: check size +/- 5%, defined content size = 27122
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 27122, 5);		// Test [11] <- Index 11
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0012 = "www.websocket.org";
		int    requestPort0012 = 443;
		String requestFile0012 = "/js/jquery.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 95807
		// content test algorithm: check size +/- 5%, defined content size = 95807
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 95807, 5);		// Test [12] <- Index 12
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0013 = "www.websocket.org";
		int    requestPort0013 = 443;
		String requestFile0013 = "/js/stuff.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2523
		// content test algorithm: check size +/- 5%, defined content size = 2523
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 2523, 5);		// Test [13] <- Index 13
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0014 = "www.websocket.org";
		int    requestPort0014 = 443;
		String requestFile0014 = "/js/echo.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 6324
		// content test algorithm: check size +/- 5%, defined content size = 6324
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 6324, 5);		// Test [14] <- Index 14
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0015 = "www.websocket.org";
		int    requestPort0015 = 443;
		String requestFile0015 = "/js/bootstrap.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 36817
		// content test algorithm: check size +/- 5%, defined content size = 36817
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 36817, 5);		// Test [15] <- Index 15
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0016 = "www.websocket.org";
		int    requestPort0016 = 443;
		String requestFile0016 = "/js/easing.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 3436
		// content test algorithm: check size +/- 5%, defined content size = 3436
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 3436, 5);		// Test [16] <- Index 16
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0017 = "www.websocket.org";
		int    requestPort0017 = 443;
		String requestFile0017 = "/js/wow.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 4779
		// content test algorithm: check size +/- 5%, defined content size = 4779
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 4779, 5);		// Test [17] <- Index 17
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0018 = "www.websocket.org";
		int    requestPort0018 = 443;
		String requestFile0018 = "/js/appear.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2516
		// content test algorithm: check size +/- 5%, defined content size = 2516
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 2516, 5);		// Test [18] <- Index 18
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0019 = "www.websocket.org";
		int    requestPort0019 = 443;
		String requestFile0019 = "/js/fitvids.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 3516
		// content test algorithm: check size +/- 5%, defined content size = 3516
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 3516, 5);		// Test [19] <- Index 19
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0020 = "www.websocket.org";
		int    requestPort0020 = 443;
		String requestFile0020 = "/js/common.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 5145
		// content test algorithm: check size +/- 5%, defined content size = 5145
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 5145, 5);		// Test [20] <- Index 20
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0021 = "www.websocket.org";
		int    requestPort0021 = 443;
		String requestFile0021 = "/js/flexslider.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 41415
		// content test algorithm: check size +/- 5%, defined content size = 41415
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 41415, 5);		// Test [21] <- Index 21
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0022 = "www.websocket.org";
		int    requestPort0022 = 443;
		String requestFile0022 = "/js/countto.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2841
		// content test algorithm: check size +/- 5%, defined content size = 2841
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 2841, 5);		// Test [22] <- Index 22
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0023 = "fonts.gstatic.com";
		int    requestPort0023 = 443;
		String requestFile0023 = "/s/opensans/v13/cJZKeOuBrn4kERxqtaUH3ZBw1xU1rKptJj_0jans920.woff2";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/WOFF2", null, 10352, 5);		// Test [23] <- Index 23
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0024 = "maxcdn.bootstrapcdn.com";
		int    requestPort0024 = 443;
		String requestFile0024 = "/font-awesome/4.4.0/fonts/fontawesome-webfont.woff2" +
				"?v=4.4.0";
		...
		// verify response: status code = 200, content type = "APPLICATION/FONT-WOFF2", header text fragment = [verification disabled], recorded content size = 64464
		// content test algorithm: check size +/- 5%, defined content size = 64464
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/FONT-WOFF2", null, 64464, 5);		// Test [24] <- Index 24
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0025 = "fonts.gstatic.com";
		int    requestPort0025 = 443;
		String requestFile0025 = "/s/abeezee/v10/yTibYMDoFfqshd01j2jrvwLUuEpTyoUstqEm5AMlJo4.woff2";
		...
		// verify response: status code = 200, content type = "FONT/WOFF2", header text fragment = [verification disabled], recorded content size = 11128
		// content test algorithm: check size +/- 5%, defined content size = 11128
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/WOFF2", null, 11128, 5);		// Test [25] <- Index 25
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0026 = "fonts.gstatic.com";
		int    requestPort0026 = 443;
		String requestFile0026 = "/s/opensans/v13/k3k702ZOKiLJc3WVjuplzBampu5_7CjHW5spxoeN3Vs.woff2";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/WOFF2", null, 10284, 5);		// Test [26] <- Index 26
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0027 = "fonts.gstatic.com";
		int    requestPort0027 = 443;
		String requestFile0027 = "/s/opensans/v13/MTP_ySUJH_bn48VBG8sNShampu5_7CjHW5spxoeN3Vs.woff2";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "FONT/WOFF2", null, 10328, 5);		// Test [27] <- Index 27
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0028 = "script.crazyegg.com";
		int    requestPort0028 = 443;
		String requestFile0028 = "/pages/scripts/0037/0800.js" +
				"?415568";
		...
		// content test algorithm: check size +/- 5%, defined content size = 0
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 0, 5);		// Test [28] <- Index 28
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0029 = "www.websocket.org";
		int    requestPort0029 = 443;
		String requestFile0029 = "/js/jquery.cycle.all.min.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 26202
		// content test algorithm: check size +/- 5%, defined content size = 26202
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 26202, 5);		// Test [29] <- Index 29
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0030 = "www.websocket.org";
		int    requestPort0030 = 443;
		String requestFile0030 = "/js/carousel-testimonials.js";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 519, 5);		// Test [30] <- Index 30
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0031 = "www.websocket.org";
		int    requestPort0031 = 443;
		String requestFile0031 = "/js/carousel-anything.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 544
		// content test algorithm: check size +/- 5%, defined content size = 544
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 544, 5);		// Test [31] <- Index 31
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0032 = "www.websocket.org";
		int    requestPort0032 = 443;
		String requestFile0032 = "/js/carousel.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 23890
		// content test algorithm: check size +/- 5%, defined content size = 23890
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 23890, 5);		// Test [32] <- Index 32
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0033 = "www.websocket.org";
		int    requestPort0033 = 443;
		String requestFile0033 = "/js/isotope.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 44861
		// content test algorithm: check size +/- 5%, defined content size = 44861
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 44861, 5);		// Test [33] <- Index 33
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0034 = "www.websocket.org";
		int    requestPort0034 = 443;
		String requestFile0034 = "/js/carousel-blog.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 542
		// content test algorithm: check size +/- 5%, defined content size = 542
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 542, 5);		// Test [34] <- Index 34
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0035 = "www.websocket.org";
		int    requestPort0035 = 443;
		String requestFile0035 = "/js/parallax.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2228
		// content test algorithm: check size +/- 5%, defined content size = 2228
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 2228, 5);		// Test [35] <- Index 35
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0036 = "www.websocket.org";
		int    requestPort0036 = 443;
		String requestFile0036 = "/js/validate.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 2277
		// content test algorithm: check size +/- 5%, defined content size = 2277
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 2277, 5);		// Test [36] <- Index 36
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0037 = "www.websocket.org";
		int    requestPort0037 = 443;
		String requestFile0037 = "/js/prettify.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 13632
		// content test algorithm: check size +/- 5%, defined content size = 13632
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 13632, 5);		// Test [37] <- Index 37
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0038 = "www.websocket.org";
		int    requestPort0038 = 443;
		String requestFile0038 = "/img/websocketlogo-medium.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 6580, 5);		// Test [38] <- Index 38
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0039 = "www.websocket.org";
		int    requestPort0039 = 443;
		String requestFile0039 = "/img/check.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 635, 5);		// Test [39] <- Index 39
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0040 = "www.websocket.org";
		int    requestPort0040 = 443;
		String requestFile0040 = "/img/clear.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 82, 5);		// Test [40] <- Index 40
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
	...
	boolean executePage_1_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0041 = "www.websocket.org";
		int    requestPort0041 = 443;
		String requestFile0041 = "/img/cross.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 670, 5);		// Test [41] <- Index 41
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0042 = "www.websocket.org";
		int    requestPort0042 = 443;
		String requestFile0042 = "/img/websocketlogo-medium-white.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 18496, 5);		// Test [42] <- Index 42
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0043 = "www.websocket.org";
		int    requestPort0043 = 443;
		String requestFile0043 = "/img/favicon.ico";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, null, null, 3638, 5);		// Test [43] <- Index 43
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0044 = "www.google-analytics.com";
		int    requestPort0044 = 443;
		String requestFile0044 = "/analytics.js";
		...
		// verify response: status code = 200, content type = "TEXT/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 12349
		// content test algorithm: check size +/- 5%, defined content size = 12349
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/JAVASCRIPT", null, 12349, 5);		// Test [44] <- Index 44
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0045 = "tag.getdrip.com";
		int    requestPort0045 = 443;
		String requestFile0045 = "/6914321.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 8
		// content test algorithm: check size +/- 5%, defined content size = 8
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 8, 5);		// Test [45] <- Index 45
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0046 = "assets.zendesk.com";
		int    requestPort0046 = 443;
		String requestFile0046 = "/embeddable_framework/main.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 544618
		// content test algorithm: check size +/- 5%, defined content size = 544618
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 544618, 5);		// Test [46] <- Index 46
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0047 = "www.google-analytics.com";
		int    requestPort0047 = 443;
		String requestFile0047 = "/r/collect" +
				"?v=1" +
				"&_v=j55" +
				"&a=630229319" +
				"&t=pageview" +
				"&_s=1" +
				"&dl=https%3A%2F%2Fwww.websocket.org%2Fecho.html" +
				"&ul=en-gb" +
				"&de=UTF-8" +
				"&dt=websocket.org%20Echo%20Test%20-%20Powered%20by%20Kaazing" +
				"&sd=24-bit" +
				"&sr=1920x1080" +
				"&vp=1619x875" +
				"&je=0" +
				...
				"&jid=234745966" +
				"&gjid=619505397" +
				"&cid=1890357958.1496047107" +
				"&tid=UA-1771436-4" +
				"&_gid=1375936743.1496047107" +
				"&_r=1" +
				"&z=2100540800";
		...
		// verify response: status code = 302, content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 417
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {302}, null, null, null);		// Test [47] <- Index 47
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0048 = "stats.g.doubleclick.net";
		int    requestPort0048 = 443;
		String requestFile0048 = "/r/collect" +
				"?v=1" +
				"&aip=1" +
				"&t=dc" +
				"&_r=3" +
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/GIF", null, 35, 5);		// Test [48] <- Index 48
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0049 = "kaazingsupport.zendesk.com";
		int    requestPort0049 = 443;
		String requestFile0049 = "/embeddable/config";
		String requestHeader0049 = "GET " + requestFile0049 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: kaazingsupport.zendesk.com\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
				"Accept: */*\r\n" + 
				"Accept-Language: en-GB,en;q=0.5\r\n" + 
				"Accept-Encoding: gzip, deflate, br\r\n" + 
		...
		// verify response: status code = 200, content type = "APPLICATION/JSON", header text fragment = [verification disabled], recorded content size = 188
		// content test algorithm: check size +/- 5%, defined content size = 188
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JSON", null, 188, 5);		// Test [49] <- Index 49
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0050 = "v2.zopim.com";
		int    requestPort0050 = 443;
		String requestFile0050 = "/" +
				"?3vCaGRDlZbbiX5tJXSlIABEcEDu5cGAg";
		...
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {302}, null, null, null);		// Test [50] <- Index 50
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0051 = "kaazingsupport.zendesk.com";
		int    requestPort0051 = 443;
		String requestFile0051 = "/embeddable_blip" +
				"?data=";
		...
		// verify response: status code = 200, content type = "APPLICATION/OCTET-STREAM", header text fragment = [verification disabled], recorded content size = 0
		// content test algorithm: check size +/- 5%, defined content size = 0
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/OCTET-STREAM", null, 0, 5);		// Test [51] <- Index 51
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0052 = "v2.zopim.com";
		int    requestPort0052 = 443;
		String requestFile0052 = "/bin/v/widget_v2.202.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 248044
		// content test algorithm: check size +/- 5%, defined content size = 248044
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 248044, 5);		// Test [52] <- Index 52
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0053 = "kaazingsupport.zendesk.com";
		int    requestPort0053 = 443;
		String requestFile0053 = "/embeddable_blip" +
				"?data=%3D%3D";
		...
		// verify response: status code = 200, content type = "APPLICATION/OCTET-STREAM", header text fragment = [verification disabled], recorded content size = 0
		// content test algorithm: check size +/- 5%, defined content size = 0
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/OCTET-STREAM", null, 0, 5);		// Test [53] <- Index 53
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0054 = "de18.zopim.com";
		int    requestPort0054 = 443;
		String requestFile0054 = "/s/W/ws/f+2rbZqx8Sfn+0ak/c/1496047108929";
		String requestHeader0054 = "GET " + requestFile0054 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Origin: https://www.websocket.org\r\n" + 
				"Sec-WebSocket-Extensions: permessage-deflate\r\n" + 
				"Sec-WebSocket-Key: X2ODDvZQeWaw+QgB1EwwWg==\r\n" + 
				"Connection: Keep-Alive, Upgrade\r\n" + 
				"Pragma: no-cache\r\n" + 
				"Cache-Control: no-cache\r\n" + 
				"Upgrade: websocket\r\n" + 
		...
		webSocketData = getWebSocketData_1496047109362();
		testURL.setWebSocketContext(new HttpTestWebsocketContext(webSocketData, null, null));
		...
		// verify response: status code = 101, content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 0
		// content test algorithm: check size +/- 5%, defined content size = 0
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {101}, null, null, 0, 5);		// Test [54] <- Index 54
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0055 = "echo.websocket.org";
		int    requestPort0055 = 443;
		String requestFile0055 = "/" +
				"?encoding=text";
		String requestHeader0055 = "GET " + requestFile0055 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Origin: https://www.websocket.org\r\n" + 
				"Sec-WebSocket-Extensions: permessage-deflate\r\n" + 
				"Sec-WebSocket-Key: DmNTbzfH2pIhO9LI7cnLVQ==\r\n" + 
				"Connection: Keep-Alive, Upgrade\r\n" + 
				"Pragma: no-cache\r\n" + 
				"Cache-Control: no-cache\r\n" + 
				"Upgrade: websocket\r\n" + 
		...
		LoadtestPluginContext urlPluginBeforeCallContext0055 = new LoadtestPluginContext(prxVersion, prxCharEncoding, this, threadNumber, socketPool, cookieHandler, testURL, threadStep);

		webSocketData = getWebSocketData_1496047109772();

		webSocketPluginsForURL = new WebSocketPluginInterface[1];

		webSocketPluginsForURL[0] = (WebSocketPluginInterface) wsplugin01;

		testURL.setWebSocketContext(new HttpTestWebsocketContext(webSocketData, webSocketPluginsForURL, urlPluginBeforeCallContext0055));
		...
		// verify response: status code = 101, content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 0
		// content test algorithm: check size +/- 5%, defined content size = 0
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {101}, null, null, 0, 5);		// Test [55] <- Index 55
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0056 = "www.websocket.org";
		int    requestPort0056 = 443;
		String requestFile0056 = "/img/tls-lock.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 245
		// content test algorithm: check size +/- 5%, defined content size = 245
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 245, 5);		// Test [56] <- Index 56
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0057 = "127.0.0.1";
		int    requestPort0057 = 7990;
		String requestFile0057 = "/dfischer/webadmininterface/BrowserExtensionWeblet" +
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/HTML", null, 2, 5);		// Test [57] <- Index 57
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("SocketTransfer", concurrentUsers, ParseArgs.getString(args, "-executionPlan"));
		...
		final int MAX_THREAD_STEPS = 57;  // number of URL requests in execute() - modify this value if you add or delete some requests
		...
		performanceData.setInfoText("SocketTransfer");
		...
		{
			System.out.println("global var <<< someVar = " + someVar);
			System.out.println();
		}
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new SocketTransfer());
		
		try
		{
			// define object for web socket plug-in #1 and call web socket plug-in constructor
			Class wspluginClass0 = getPluginClassLoader().getPluginClass("sree");
			wsplugin01 = wspluginClass0.newInstance();
			((GenericPluginInterface) wsplugin01).construct(globalPluginContext);
		}
		...
		if (hasExecutionPlan())
		{
			...
			try
			{
				...
				SocketTransfer simulatedUser = new SocketTransfer(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
			...
			if (abortedByRemote() || abortedByEofInputFile())
			{
				...
				synchronized (dumpLock)
				{
					...
					try
					{
						...
						// deconstruct all global constructed  web socket plug-ins
						((GenericPluginInterface) wsplugin01).deconstruct(globalPluginContext);
					}
					catch (Throwable pluginThrowable)
					{
						System.out.println("*** ERROR: EXECUTION OF WEB SOCKET PLUG-IN FAILED ***");
	...
	public WebSocketData getWebSocketData_1496047105200()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1496047105233L);
		webSocketData.setConnectionStopMillis(1496047105657L);
		webSocketData.setSecProtocol("plain");
		String payLoad_1 = "\u0003\u00fd";


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1496047105620L,1496047105621L  , payLoad_1, WebSocketFrame.PLAIN  ));
	
		return webSocketData;
	}
	
	// source code getting the webSocket context.
	public WebSocketData getWebSocketData_1496047109362()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1496047109395L);
		webSocketData.setConnectionStopMillis(1496047130494L);
		webSocketData.setSecProtocol("plain");
		String payLoad_1 = "1496047109399\n0\n1\n0\nd\n{\"__type\":\"register\",\"accountKey\":\"3vCaGRDlZbbiX5tJXSlIABEcEDu5cGAg\",\"cookie_law\":false,\"dt\":\"desktop\",\"mID\":\"\",\"ref\":\"https://www.websocket.org/echo.html\",\"rev\":\"7a9e5d2a57beec602ae6ecbab0479263f500e355\",\"source\":\"widget_v2\",\"theme\":\"simple\",\"title\":\"websocket.org Echo Test - Powered by Kaazing\",\"ua\":\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:53.0) Gecko/20100101 Firefox/53.0\",\"url\":\"https://www.websocket.org/echo.html\"}";
		String payLoad_4 = "1496047109590\n1077.0260602994847\n2\n3\nd\n{\"__type\":\"instrumentation\",\"metrics\":[{\"method\":\"histogram\",\"name\":\"start_exec\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.529},{\"method\":\"histogram\",\"name\":\"init_ui_components_cached\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.086},{\"method\":\"histogram\",\"name\":\"theme_loaded_cached\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.323},{\"method\":\"increment\",\"name\":\"conn\",\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\",\"tries:1\"],\"value\":1},{\"method\":\"histogram\",\"name\":\"conn_open\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\",\"proxy:de18.zopim.com\"],\"value\":0.47},{\"method\":\"histogram\",\"name\":\"conn_status_connected\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.572}]}\n{\"__type\":\"instrumentation\",\"metrics\":[{\"method\":\"histogram\",\"name\":\"conn_status_registered\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.71}]}\n{\"__type\":\"instrumentation\",\"metrics\":[{\"method\":\"histogram\",\"name\":\"conn_status_reattached\",\"sample_rate\":0.25,\"tags\":[\"browser:firefox\",\"device:desktop\",\"platform:mac\",\"rev:7a9e5d2a57beec602ae6ecbab0479263f500e355\"],\"value\":0.71}]}\n{\"path\":[\"root\",\"livechat\",\"profile\"],\"value\":{\"active$int\":1496047108932}}\n{\"path\":[\"root\",\"livechat\",\"channel\",\"tags\"],\"value\":{\"added$string\":\"websocket_org\"}}\n{\"path\":[\"root\",\"livechat\",\"profile\"],\"value\":{\"disconnect_timeout$int\":20}}";
		String payLoad_5 = "1496047128939\n1077.0260602994847\n3\n3\nd\n{\"path\":[\"root\",\"livechat\",\"profile\"],\"value\":{\"active$int\":1496047128938}}";
		String payLoad_6 = "\u0003\u00fd";


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1496047109399L,1496047109400L  , payLoad_1, WebSocketFrame.PLAIN  ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1496047109590L,1496047109591L  , payLoad_4, WebSocketFrame.PLAIN  ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1496047128940L,1496047128941L  , payLoad_5, WebSocketFrame.PLAIN  ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1496047130460L,1496047130460L  , payLoad_6, WebSocketFrame.PLAIN  ));
	
		return webSocketData;
	}
	
	// source code getting the webSocket context.
	public WebSocketData getWebSocketData_1496047109772()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1496047109902L);
		webSocketData.setConnectionStopMillis(1496047124105L);
		webSocketData.setSecProtocol("plain");
		String payLoad_0 = "Rock it with HTML5 WebSocket";
		String payLoad_2 = "Rock it with HTML5 WebSocket";
		String payLoad_4 = "";

		// search and replace frame payload "WebSocket" with variable 'someVar' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceTextPattern(payLoad_0, "WebSocket", someVar, 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1496047114467L,1496047114467L  , payLoad_0, WebSocketFrame.PLAIN  ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1496047121930L,1496047121931L  , payLoad_2, WebSocketFrame.PLAIN  ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1496047123972L,1496047123972L  , payLoad_4, WebSocketFrame.PLAIN  ));

 ...
 * Automatically generated load test program.
 */
public class clDemo2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "clDemo2ExtParams.dat";               // input file name for very large parameter values
	 ...
	 */
	public clDemo2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		for (urlLoopCounter1 = 0; urlLoopCounter1 < 10; urlLoopCounter1++)
		{
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("clDemo2", concurrentUsers);
		...
		performanceData.setInfoText("clDemo2");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new clDemo2());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				clDemo2 simulatedUser = new clDemo2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

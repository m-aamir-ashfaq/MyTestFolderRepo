...
// -----------------------------------------
//
// Source: TV4_stream_rev1feb1133.java
// Date  : 01 Feb 2016 10:05:51 ECT
 ...
 * Automatically generated load test program.
 */
public class TV4_stream_rev1feb1133 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "TV4_stream_rev1feb1133ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public TV4_stream_rev1feb1133(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("TV4_stream_rev1feb1133", concurrentUsers);
		...
		performanceData.setInfoText("TV4_stream_rev1feb1133");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				TV4_stream_rev1feb1133 simulatedUser = new TV4_stream_rev1feb1133(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

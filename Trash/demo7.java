...
public class demo7 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("demo7", concurrentUsers);
		...
		performanceData.setInfoText("demo7");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				demo7 simulatedUser = new demo7(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public static WebSocketData getWebSocketData_1470689578084()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1470689578193L);
		webSocketData.setConnectionStopMillis(1470689630583L);
		...
		String payLoad_4 = "wait for pinggggginggg";
		String payLoad_5 = "wait for pinggggginggg";
		String payLoad_6 = "seems done";
		String payLoad_7 = "seems done";
		String payLoad_8 = "";
		String payLoad_9 = "";

		// search and replace frame payload "WebSocket" with variable 'kkj' on all occurrences of frame no 2
		payLoad_2 = Lib.replaceTextPattern(payLoad_2, "WebSocket", kkj, 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470689580565L,1470689580568L , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470689580680L,1470689580682L , payLoad_1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470689583572L,1470689583574L , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470689583682L,1470689583684L , payLoad_3 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470689590957L,1470689590958L , payLoad_4 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470689591068L,1470689591069L , payLoad_5 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1470689628803L,1470689628805L , payLoad_6 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 1 , 1470689628913L,1470689628914L , payLoad_7 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1470689630473L,1470689630474L , payLoad_8 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 8 , 1470689630581L,1470689630583L , payLoad_9 ));

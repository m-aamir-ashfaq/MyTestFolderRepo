 ...
 * Automatically generated load test program.
 */
public class test2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "test2ExtParams.dat";                 // input file name for very large parameter values
	 ...
	 */
	public test2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("test2", concurrentUsers);
		...
		performanceData.setInfoText("test2");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new test2());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				test2 simulatedUser = new test2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1480925797650()
	{
		...
		String payLoad_2 = "{\"subscribe_topics\":[{\"subscribe_topic\":\"mitsuruog\",\"subscribe_QoS\":0}],\"DUP\":false,\"QoS\":1,\"messageID\":9808,\"retain\":false,\"type\":\"SUBSCRIBE\"}";
		String payLoad_4 = "{\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :)\",\"publish_topic\":\"\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_6 = "{\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) again\",\"publish_topic\":\"\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_8 = "{\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) once more...\",\"publish_topic\":\"\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_10 = "{\"DUP\":false,\"QoS\":1,\"messageID\":10832,\"retain\":false,\"type\":\"UNSUBSCRIBE\",\"unsubscribe_topic\":[\"mitsuruog\"]}";
		String payLoad_12 = "{\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) After Unsubscribe..\",\"publish_topic\":\"\",\"retain\":false,\"type\":\"PUBLISH\"}";
		...
		payLoad_0 = Lib.replaceJsonFieldPattern(payLoad_0, "client_id", "4f92e0c009b7409f", tempVar, 0);

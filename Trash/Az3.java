 ...
 * Automatically generated load test program.
 */
public class Az3 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "Az3ExtParams.dat";                   // input file name for very large parameter values
	 ...
	 */
	public Az3(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("Az3", concurrentUsers);
		...
		performanceData.setInfoText("Az3");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new Az3());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				Az3 simulatedUser = new Az3(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

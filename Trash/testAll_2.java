...
// -----------------------------------------
//
// Source: testAll_2.java
// Date  : 27 Jan 2017 10:35:36 ECT
 ...
 * Automatically generated load test program.
 */
public class testAll_2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "testAll_2ExtParams.dat";             // input file name for very large parameter values
	 ...
	 */
	public testAll_2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [2] <- WEB ADMIN Index 9 ---
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("testAll_2", concurrentUsers);
		...
		performanceData.setInfoText("testAll_2");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new testAll_2());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				testAll_2 simulatedUser = new testAll_2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

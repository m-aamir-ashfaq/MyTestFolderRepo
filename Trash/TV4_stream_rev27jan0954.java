...
// -----------------------------------------
//
// Source: TV4_stream_rev27jan0954.java
// Date  : 27 Jan 2016 11:07:07 ECT
 ...
 * Automatically generated load test program.
 */
public class TV4_stream_rev27jan0954 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "TV4_stream_rev27jan0954ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public TV4_stream_rev27jan0954()
	{
		super();
	}
	 ...
	 */
	public TV4_stream_rev27jan0954(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("TV4_stream_rev27jan0954", concurrentUsers);
		...
		performanceData.setInfoText("TV4_stream_rev27jan0954");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				TV4_stream_rev27jan0954 simulatedUser = new TV4_stream_rev27jan0954(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

...
// -----------------------------------------
//
// Source: websocketIO2_2.java
// Date  : 15 Jul 2016 14:48:43 ECT
 ...
 * Automatically generated load test program.
 */
public class websocketIO2_2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "websocketIO2_2ExtParams.dat";        // input file name for very large parameter values
	...
	private static String var1 = "lyrics";                                       // var declaration from web admin var handler: scope = global
	 ...
	 */
	public websocketIO2_2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [3] <- WEB ADMIN Index 46 ---
		log();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("websocketIO2_2", concurrentUsers);
		...
		performanceData.setInfoText("websocketIO2_2");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				websocketIO2_2 simulatedUser = new websocketIO2_2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public static WebSocketData getWebSocketData_1468573362213()
	{
		...
		// search and replace frame payload "HTML5 WebSocket" with variable 'var1' on all occurrences of all frames.
		payLoad_0 = Lib.replaceTextPattern(payLoad_0, "HTML5 WebSocket", var1, 0);
		payLoad_1 = Lib.replaceTextPattern(payLoad_1, "HTML5 WebSocket", var1, 0);
		payLoad_2 = Lib.replaceTextPattern(payLoad_2, "HTML5 WebSocket", var1, 0);
		payLoad_3 = Lib.replaceTextPattern(payLoad_3, "HTML5 WebSocket", var1, 0);
		payLoad_4 = Lib.replaceTextPattern(payLoad_4, "HTML5 WebSocket", var1, 0);
		payLoad_5 = Lib.replaceTextPattern(payLoad_5, "HTML5 WebSocket", var1, 0);
		payLoad_6 = Lib.replaceTextPattern(payLoad_6, "HTML5 WebSocket", var1, 0);
		payLoad_7 = Lib.replaceTextPattern(payLoad_7, "HTML5 WebSocket", var1, 0);
		payLoad_8 = Lib.replaceTextPattern(payLoad_8, "HTML5 WebSocket", var1, 0);
		payLoad_9 = Lib.replaceTextPattern(payLoad_9, "HTML5 WebSocket", var1, 0);

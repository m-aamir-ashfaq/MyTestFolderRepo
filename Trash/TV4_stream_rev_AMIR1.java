...
// -----------------------------------------
//
// Source: TV4_stream_rev_AMIR1.java
// Date  : 12 Feb 2016 13:30:41 ECT
 ...
 * Automatically generated load test program.
 */
public class TV4_stream_rev_AMIR1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "TV4_stream_rev_AMIR1ExtParams.dat";  // input file name for very large parameter values
	 ...
	 */
	public TV4_stream_rev_AMIR1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("TV4_stream_rev_AMIR1", concurrentUsers);
		...
		performanceData.setInfoText("TV4_stream_rev_AMIR1");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				TV4_stream_rev_AMIR1 simulatedUser = new TV4_stream_rev_AMIR1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

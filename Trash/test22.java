 ...
 * Automatically generated load test program.
 */
public class test22 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "test22ExtParams.dat";                // input file name for very large parameter values
	...
	private static String tempVar = "tempValue";                                 // var declaration from web admin var handler: scope = global
	 ...
	 */
	public test22(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "test.mosquitto.org";
		int    requestPort0001 = 8080;
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: hadWyUDrUaRoNS6vNYlY6g==\r\n" + 
		...
		webSocketData = getWebSocketData_1480925797650();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("test22", concurrentUsers);
		...
		performanceData.setInfoText("test22");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new test22());
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				test22 simulatedUser = new test22(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1480925797650()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1480925797737L);
		webSocketData.setConnectionStopMillis(1480925821771L);
		String payLoad_0 = "{\"DUP\":false,\"QoS\":0,\"userNameFlag\":0,\"last_will_Flag\":0,\"keep_alive\":60,\"retain\":false,\"client_id\":\"mqttjs_4f92e0c009b7409f\",\"clean_session\":true,\"type\":\"CONNECT\",\"passwordFlag\":0,\"protocol_name\":\"MQIsdp\",\"protocol_version\":3}";
		String payLoad_2 = "{\"DUP\":false,\"QoS\":1,\"messageID\":9808,\"retain\":false,\"type\":\"SUBSCRIBE\",\"subscribeTopics\":[{\"subscribe_topic\":\"mitsuruog\",\"subscribe_QoS\":0}]}";
		String payLoad_4 = "{\"topic\":\"mitsuruog\",\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :)\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_6 = "{\"topic\":\"mitsuruog\",\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) again\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_8 = "{\"topic\":\"mitsuruog\",\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) once more...\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_10 = "{\"DUP\":false,\"QoS\":1,\"messageID\":10832,\"retain\":false,\"type\":\"UNSUBSCRIBE\",\"unsubscribe_topic\":[\"mitsuruog\"]}";
		String payLoad_12 = "{\"topic\":\"mitsuruog\",\"DUP\":false,\"QoS\":0,\"contents\":\"Hello mitsuruog :) After Unsubscribe..\",\"retain\":false,\"type\":\"PUBLISH\"}";
		String payLoad_13 = "{\"DUP\":false,\"QoS\":0,\"retain\":false,\"type\":\"DISCONNECT\"}";
		String payLoad_14 = "";

		// search and replace field "client_id" with variable 'tempVar' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceJsonFieldPattern(payLoad_0, "client_id", 4f92e0c009b7409f, 0);

		// search and replace field "keep_alive" with variable 'tempVar' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceJsonFieldPattern(payLoad_0, "keep_alive", , 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925797740L,1480925797741L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925799193L,1480925799195L , "ISO-8859-1" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925801705L,1480925801706L , "UTF-8" , payLoad_4 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925804990L,1480925804992L , "UTF-8" , payLoad_6 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925809510L,1480925809511L , "UTF-8" , payLoad_8 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925811608L,1480925811609L , "ISO-8859-1" , payLoad_10 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925820161L,1480925820162L , "UTF-8" , payLoad_12 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1480925821696L,1480925821697L , "ISO-8859-1" , payLoad_13 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1480925821697L,1480925821699L , "UTF-8" , payLoad_14 ));

...
// -----------------------------------------
//
// Source: sessionWithWebSocketDa222TestCreation.java
// Date  : 14 Jun 2016 13:33:30 ECT
 ...
 * Automatically generated load test program.
 */
public class sessionWithWebSocketDa222TestCreation extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "sessionWithWebSocketDa222TestCreationExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public sessionWithWebSocketDa222TestCreation()
	{
		super();
	}
	 ...
	 */
	public sessionWithWebSocketDa222TestCreation(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestContent0001 = 
				requestFileCache.readFile(getSymmetricEncryptContext(), "sessionWithWebSocketDa222TestCreation_RequestContent0001.txt").getFileDataAsString("UTF-8");		// note: consider duplicated definition of this file name near end of the load test program - used for ZIP-dialogue in Project Navigator
...
WebSocketData webSocketData = null
		...
		String requestContent0002 = 
				requestFileCache.readFile(getSymmetricEncryptContext(), "sessionWithWebSocketDa222TestCreation_RequestContent0002.txt").getFileDataAsString("UTF-8");		// note: consider duplicated definition of this file name near end of the load test program - used for ZIP-dialogue in Project Navigator
...
webSocketData.setConnectionStartMillis(1464269093599);
webSocketData.setConnectionStopMillis(1464269192521);
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,9,false,0,null,[B@357a25c3,false,0,-119,0,null,1464269123688,1464269123689))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,10,true,0,[B@664540a2,[B@4c968022,false,0,-118,-128,null,1464269123690,1464269123691))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,true,35,[B@2cb65f76,[B@793552e8,false,0,-127,-93,null,1464269134255,1464269134256))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,false,35,null,[B@1bd63b83,false,0,-127,35,null,1464269134372,1464269134373))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,true,126,[B@ddd23bc,[B@315512c0,false,2,-127,-2,[B@4842148d,1464269143131,1464269143132))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,false,126,null,[B@6a535a0a,false,2,-127,126,[B@63c7d0f,1464269143248,1464269143249))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,true,127,[B@6d3666fb,[B@ea320c1,false,2,-127,-2,[B@77bb6668,1464269152577,1464269152578))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,false,127,null,[B@30407341,false,2,-127,126,[B@574ec926,1464269152707,1464269152709))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,true,128,[B@75780a91,[B@1bfdf1d7,false,2,-127,-2,[B@3d10689c,1464269160872,1464269160873))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,false,128,null,[B@43f916,false,2,-127,126,[B@6e96137c,1464269160997,1464269160998))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,true,778,[B@3ed96a9c,[B@33e64800,false,2,-127,-2,[B@5381129e,1464269183504,1464269183505))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,1,false,778,null,[B@3eed6de6,false,2,-127,126,[B@55ca3750,1464269183623,1464269183624))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,8,true,0,[B@4ef59130,[B@5c0f0ecf,false,0,-120,-128,null,1464269192388,1464269192389))
webSocketData.addWebSocketFrame(new WebSocketFrame(true,false,false,false,8,false,0,null,[B@60956740,false,0,-120,0,null,1464269192519,1464269192520))
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestContent0005 = 
				requestFileCache.readFile(getSymmetricEncryptContext(), "sessionWithWebSocketDa222TestCreation_RequestContent0005.txt").getFileDataAsString();		// note: consider duplicated definition of this file name near end of the load test program - used for ZIP-dialogue in Project Navigator
...
WebSocketData webSocketData = null
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("sessionWithWebSocketDa222TestCreation", concurrentUsers);
		...
		performanceData.setInfoText("sessionWithWebSocketDa222TestCreation");
		...
		try
		{
			requestFileCache.readFile(getSymmetricEncryptContext(), REQUEST_FILE_CACHE_FILE_1);		// sessionWithWebSocketDa222TestCreation_RequestContent0001.txt
			requestFileCache.readFile(getSymmetricEncryptContext(), REQUEST_FILE_CACHE_FILE_2);		// sessionWithWebSocketDa222TestCreation_RequestContent0002.txt
			requestFileCache.readFile(getSymmetricEncryptContext(), REQUEST_FILE_CACHE_FILE_3);		// sessionWithWebSocketDa222TestCreation_RequestContent0005.txt
		}
		catch (IOException ie)
		{
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				sessionWithWebSocketDa222TestCreation simulatedUser = new sessionWithWebSocketDa222TestCreation(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	// --------------------------------------------------------------------------------
	public static final String REQUEST_FILE_CACHE_FILE_1 = "sessionWithWebSocketDa222TestCreation_RequestContent0001.txt";		// must be zipped together with the compiled class of this load test program
	public static final String REQUEST_FILE_CACHE_FILE_2 = "sessionWithWebSocketDa222TestCreation_RequestContent0002.txt";		// must be zipped together with the compiled class of this load test program
	public static final String REQUEST_FILE_CACHE_FILE_3 = "sessionWithWebSocketDa222TestCreation_RequestContent0005.txt";		// must be zipped together with the compiled class of this load test program

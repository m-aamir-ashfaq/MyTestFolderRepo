...
// -----------------------------------------
//
// Source: TV4_stream_rev27jan0857.java
// Date  : 27 Jan 2016 09:49:17 ECT
 ...
 * Automatically generated load test program.
 */
public class TV4_stream_rev27jan0857 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "TV4_stream_rev27jan0857ExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public TV4_stream_rev27jan0857()
	{
		super();
	}
	 ...
	 */
	public TV4_stream_rev27jan0857(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("TV4_stream_rev27jan0857", concurrentUsers);
		...
		performanceData.setInfoText("TV4_stream_rev27jan0857");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				TV4_stream_rev27jan0857 simulatedUser = new TV4_stream_rev27jan0857(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

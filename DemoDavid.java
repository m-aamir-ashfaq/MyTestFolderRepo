...
// -----------------------------------------
//
// Source: DemoDavid.java
// Date  : 29 Aug 2016 13:39:53 ECT
 ...
 * Automatically generated load test program.
 */
public class DemoDavid extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "DemoDavidExtParams.dat";             // input file name for very large parameter values
	...
	private String var2 = null;                          // var declaration from web admin var handler: scope = per loop
	private String var1 = null;                          // var declaration from web admin var handler: scope = per loop
	 ...
	 */
	public DemoDavid(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [1] <- WEB ADMIN Index 41 ---
		...
		String requestHeader0001 = "GET " + requestFile0001 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: 0FZMIw3zN4n6wA5kDUG8FA==\r\n" + 
		...
		webSocketData = getWebSocketData_1472470533058();
	...
	boolean executePage_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// --- HTTP REQUEST: Test [3] <- WEB ADMIN Index 49 ---
		log();
		log("# title: Home | Zauq Group");
		String requestProt0003 = "http";
		String requestHost0003 = "www.zauq.com";
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("DemoDavid", concurrentUsers);
		...
		performanceData.setInfoText("DemoDavid");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				DemoDavid simulatedUser = new DemoDavid(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1472470533058()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1472470533230L);
		webSocketData.setConnectionStopMillis(1472470585677L);
		String payLoad_0 = "Rock it with HTML5 WebSocket 1";
		String payLoad_2 = "Rock it with HTML5 WebSocket 2";
		String payLoad_4 = "bye";
		String payLoad_6 = "";

		// search and replace frame payload "HTML5" with variable 'var2' on all occurrences of all frames.
		payLoad_0 = Lib.replaceTextPattern(payLoad_0, "HTML5", var2, 0);
		payLoad_2 = Lib.replaceTextPattern(payLoad_2, "HTML5", var2, 0);
		payLoad_4 = Lib.replaceTextPattern(payLoad_4, "HTML5", var2, 0);
		payLoad_6 = Lib.replaceTextPattern(payLoad_6, "HTML5", var2, 0);

		// search and replace frame payload "WebSocket" with variable 'var1' on all occurrences of frame no 0
		payLoad_0 = Lib.replaceTextPattern(payLoad_0, "WebSocket", var1, 0);


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1472470536497L,1472470536498L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1472470539792L,1472470539792L , "UTF-8" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 1 , 1472470583975L,1472470583976L , "UTF-8" , payLoad_4 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1472470585562L,1472470585563L , "UTF-8" , payLoad_6 ));

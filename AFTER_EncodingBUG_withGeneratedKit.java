...
// -----------------------------------------
//
// Source: AFTER_EncodingBUG_withGeneratedKit.java
// Date  : 23 Aug 2016 09:45:11 ECT
 ...
 * Automatically generated load test program.
 */
public class AFTER_EncodingBUG_withGeneratedKit extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "AFTER_EncodingBUG_withGeneratedKitExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public AFTER_EncodingBUG_withGeneratedKit()
	{
		super();
	}
	 ...
	 */
	public AFTER_EncodingBUG_withGeneratedKit(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("AFTER_EncodingBUG_withGeneratedKit", concurrentUsers);
		...
		performanceData.setInfoText("AFTER_EncodingBUG_withGeneratedKit");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				AFTER_EncodingBUG_withGeneratedKit simulatedUser = new AFTER_EncodingBUG_withGeneratedKit(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());

...
// -----------------------------------------
//
// Source: After_MQTT.java
// Date  : 17 Aug 2016 14:51:07 ECT
 ...
 * Automatically generated load test program.
 */
public class After_MQTT extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "After_MQTTExtParams.dat";            // input file name for very large parameter values
	 ...
	 */
	public After_MQTT(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0001 = "tiles.services.mozilla.com";
		int    requestPort0001 = 443;
		String requestFile0001 = "/v3/links/fetch/en-GB/release";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {303}, null, null, null);		// Test [1] <- Index 1
		if (!urlCallPassed)
		{
		...
		String requestHost0002 = "piwik.baycix.de";
		int    requestPort0002 = 80;
		String requestFile0002 = "/piwik.php" +
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/GIF", null, 50, 5);		// Test [2] <- Index 2
		if (!urlCallPassed)
		{
		...
		String requestFile0003 = "/desktop/STAR/en-GB.5068e5aeca3ec97a7be0b4d4e81081b70c030755.ag.json";
		...
		// verify response: status code = 200, content type = "APPLICATION/JSON", header text fragment = [verification disabled], recorded content size = 2707
		// content test algorithm: check size +/- 5%, defined content size = 2707
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JSON", null, 2707, 5);		// Test [3] <- Index 3
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0004 = "broker.mqttdashboard.com";
		int    requestPort0004 = 8000;
		...
		String requestHeader0004 = "GET " + requestFile0004 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				...
				"Sec-WebSocket-Key: ul3h8WxITTdFlEJC0gWahg==\r\n" + 
		...
		webSocketData = getWebSocketData_1471438188162();
		...
		String requestFile0005 = "/ajax/libs/fancybox/2.1.5/fancybox_overlay.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 76, 5);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0006 = "www.hivemq.com";
		int    requestPort0006 = 80;
		String requestFile0006 = "/demos/websocket-client/assets/jquery.minicolors.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 77459, 5);		// Test [6] <- Index 6
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0007 = "cdnjs.cloudflare.com";
		int    requestPort0007 = 80;
		String requestFile0007 = "/ajax/libs/fancybox/2.1.5/fancybox_sprite.png";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1362, 5);		// Test [7] <- Index 7
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("After_MQTT", concurrentUsers);
		...
		performanceData.setInfoText("After_MQTT");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				After_MQTT simulatedUser = new After_MQTT(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
	...
	public WebSocketData getWebSocketData_1471438188162()
	{

		WebSocketData webSocketData = new WebSocketData();
		webSocketData.setConnectionStartMillis(1471438188192L);
		webSocketData.setConnectionStopMillis(1471438208262L);
		String payLoad_0 = "\u0010!\u0000\u0006MQIsdp\u0003\u0002\u0000<\u0000\u0013clientId-BTdDaTMPLF";
		String payLoad_1 = " \u0002\u0000\u0000";
		String payLoad_2 = "\u0082\u0010\u0000\u0001\u0000\u000btesttopic/#\u0002";
		String payLoad_3 = "\u0090\u0003\u0000\u0001\u0002";
		String payLoad_4 = "1\u0015\u0000\u0011testtopic/switch2ON";
		String payLoad_5 = "0\u0014\u0000\u000etesttopic/amiramir";
		String payLoad_6 = "0\u0014\u0000\u000etesttopic/amiramir";
		String payLoad_7 = "0\u0016\u0000\u000etesttopic/amiramir 2";
		String payLoad_8 = "0\u0016\u0000\u000etesttopic/amiramir 2";
		String payLoad_9 = "\u00e0\u0000";
		String payLoad_10 = "";


		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1471438188197L,1471438188199L , "UTF-8" , payLoad_0 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 2 , 1471438188230L,1471438188231L , "UTF-8" , payLoad_1 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1471438192631L,1471438192631L , "ISO-8859-1" , payLoad_2 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 2 , 1471438192681L,1471438192681L , "ISO-8859-1" , payLoad_3 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 2 , 1471438192681L,1471438192682L , "UTF-8" , payLoad_4 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1471438198079L,1471438198080L , "UTF-8" , payLoad_5 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 2 , 1471438198112L,1471438198112L , "UTF-8" , payLoad_6 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1471438204047L,1471438204048L , "UTF-8" , payLoad_7 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , false , false , (byte) 2 , 1471438204092L,1471438204093L , "UTF-8" , payLoad_8 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 2 , 1471438208226L,1471438208227L , "ISO-8859-1" , payLoad_9 ));
		webSocketData.addWebSocketFrame(new WebSocketFrame( true  , true  , false , (byte) 8 , 1471438208227L,1471438208228L , "UTF-8" , payLoad_10 ));

...
// -----------------------------------------
//
// Source: AFTER_EncodingBUG2.java
// Date  : 23 Aug 2016 10:48:25 ECT
 ...
 * Automatically generated load test program.
 */
public class AFTER_EncodingBUG2 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "AFTER_EncodingBUG2ExtParams.dat";    // input file name for very large parameter values
	 ...
	 */
	public AFTER_EncodingBUG2(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("AFTER_EncodingBUG2", concurrentUsers);
		...
		performanceData.setInfoText("AFTER_EncodingBUG2");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				AFTER_EncodingBUG2 simulatedUser = new AFTER_EncodingBUG2(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
